...
export default function ModalDelete({ open, setOpen, getAll, folderId }) {
    ...
    const handleDelete = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.delete(`${baseURL}folder/${userId}/${folderId}`)
            ...
            <Dialog open={open} maxWidth="md" sx={{ ...styleDialog }}>
                ...
                <DialogContent>
                    <Box
                        ...
                        autoComplete="off"
                    >
                        <Typography sx={{fontWeight:'bold'}}>Are you sure you want to delete this folder?</Typography>
                    </Box>
                </DialogContent>
                <Box
                ...
                >
                    <Grid container spacing={2} justifyContent={'center'} sx={{ gap: 1 }} >
                        ...
                        <LoadingButton type="submit" variant="contained" sx={{ ...styleBtnAdd }} onClick={handleDelete}>
                            Delete
                        </LoadingButton>
                    </Grid>
